...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="affine_gap" -DDUCKDB_OOT_EXTENSION_AFFINE_GAP_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_AFFINE_GAP_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_AFFINE_GAP_INCLUDE_PATH="$(PROJ_DIR)src/include"
